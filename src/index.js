...
export const socketIntervalSeconds = Number(
  process.env.SOCKET_INTERVAL_SECONDS
);
export const socketCandleStickSeconds = Number(
  process.env.SOCKET_CANDLESTICK_SECONDS
);
export const activeSocketsIntervalSeconds = Number(
  process.env.ACTIVE_SOCKETS_INTERVAL_SECONDS
);
export const pm2RestartIntervalSeconds = Number(
  process.env.PM2_RESTART_INTERVAL_SECONDS
);
...
export const slackSystemStatusChannelUrl =
  process.env.SLACK_SYSTEM_STATUS_CHANNEL_URL;
export const slackSystemStatusChannelName =
  process.env.SLACK_SYSTEM_STATUS_CHANNEL_NAME;
export const systemStatusIntervalSeconds =
  process.env.SYSTEM_STATUS_INTERVAL_SECONDS;
...
export const exchange_public_token = process.env.EXCHANGE_PUBLIC_TOKEN;
